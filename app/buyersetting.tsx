...
export default function SettingsScreen() {
  ...
  const handleLogout = () => {
    Alert.alert(
      "Log Out",
      "Hmm... Are you sure you want to log out?",
      [
  ...
  return (
    <View style={[styles.container, isDarkMode && styles.darkContainer]}>
      <ScrollView style={styles.settingsContainer}>
        ...
        <SettingItem label="Analytics" icon="payment" onPress={() => router.push('../Notice')} />
        <SettingItem label="Payments and Subscription" icon="payment" onPress={() => router.push('../Notice')} />
