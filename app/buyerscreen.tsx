    ...
    <View style={styles.container}>
      ...
      <View style={styles.footer}>
        {[ 
          ...
          { icon: <FontAwesome5 name="user" size={24} color="#000" />, route: '../Notice' },
          { icon: <Ionicons name="add-circle" size={24} color="#000" />, route: '../Notice' },
          { icon: <Ionicons name="cart" size={24} color="#000" />, route: '../ProductList' },
          { icon: <Ionicons name="settings" size={24} color="#000" />, route: '../buyersetting' },
